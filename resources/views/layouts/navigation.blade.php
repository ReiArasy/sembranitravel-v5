<nav x-data="{ open: false }" class="bg-white border-b text-gray-800">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Dashboard -->
                    ...
                    @role('customer')
                    <x-nav-link :href="route('dashboard.bookings')" :active="request()->routeIs('dashboard.bookings')" class="x-nav-link">
                        {{ __('My Bookings') }}
                    </x-nav-link>
                    @endrole
            ...
            <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-gray-600 hover:text-gray-700 hover:bg-gray-100 focus:outline-none focus:text-gray-800 focus:text-gray-600 transition duration-150 ease-in-out">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @role('customer')
                    <x-responsive-nav-link  :href="route('dashboard.bookings')" :active="request()->routeIs('dashboard.bookings')" class="x-responsive-nav-link">
                        {{ __('My Bookings') }}
                    </x-responsive-nav-link>
                    @endrole
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="font-medium text-base text-gray-800">{{ Auth::user()->name }}</div>
                <div class="font-medium text-sm text-g">{{ Auth::user()->email }}</div>
            </div>
